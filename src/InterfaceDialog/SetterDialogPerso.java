...
public class SetterDialogPerso extends JDialog {
	private JLabel nomPerso, prenomPerso, adressePerso, numTelPerso, mailPerso, postePerso, sallePerso, horaireTravPerso, horairePrevPerso, salairePerso, mdpPerso, restoPerso, droitPerso;
	private JTextField nom, prenom, adresse, numTel, mail, poste, horaireTrav, horairePrev, salaire;
	...
	public SetterDialogPerso(Frame owner, boolean modal, Personnel perso) {
		...
		if(perso != null){
			...
			this.resto = new JComboBox<Restaurant>();
		}
		...
		this.horaireTravPerso = new JLabel("Horaires de Travail : ");		
		this.horaireTrav = new JTextField();
		JPanel boxHorTrav = new JPanel();
		boxHorTrav.setLayout(this.grid);
		boxHorTrav.add(this.horaireTravPerso);
		boxHorTrav.add(this.horaireTrav);
		
		this.horairePrevPerso = new JLabel("Horaires Prévus : ");
		this.horairePrev = new JTextField();
		JPanel boxHorPrev = new JPanel();
		boxHorPrev.setLayout(this.grid);
		boxHorPrev.add(this.horairePrevPerso);
		boxHorPrev.add(this.horairePrev);
		...
		public void create(){
			...
			this.perso = new Personnel(numResto, numSalle, nomPerso, prenomPerso, postePerso, adressPerso, numTelPerso, mailPerso, null, null, salairePerso, droitPerso, mdpPerso);
		}
}
